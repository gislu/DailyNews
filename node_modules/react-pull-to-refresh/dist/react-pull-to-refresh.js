	...
	var ReactPullToRefresh = (function (_Component) {
	  ...
	  _createClass(ReactPullToRefresh, [{
	    ...
	    value: function render() {
	      ...
	      return _react2['default'].createElement('div', _extends({ ref: function ref(el) {
	          _this2.body = el;
	        } }, rest), _react2['default'].createElement('div', { ref: function ref(el) {
	          _this2.ptr = el;
	        }, className: 'ptr-element' }, icon || _react2['default'].createElement('span', { className: 'genericon genericon-next' }), loading || _react2['default'].createElement('div', { className: 'loading' }, _react2['default'].createElement('span', { className: 'loading-ptr-1' }), _react2['default'].createElement('span', { className: 'loading-ptr-2' }), _react2['default'].createElement('span', { className: 'loading-ptr-3' }))), _react2['default'].createElement('div', { ref: function ref(el) {
	          _this2.refresh = el;
	        }, className: 'refresh-view' }, children));
	    }
	  }]);
